...
Dockerfile (Line 37) contains wget instructions to get openvpn server settings from an unnamed provider - You can modify this

## Below is README.MD from fork origin

source https://github.com/Hermsi1337/docker-sshd
